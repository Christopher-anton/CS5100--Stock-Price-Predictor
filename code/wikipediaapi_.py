...
def plot_graph(graph_type):
    ...
    if graph_type == 'LSTM':
        ...
        data2 = np.load('LSTM_Truex.npy')
        dates  = np.load('datesx.npy')
        ...
        data1 = np.load('GRU_Predx.npy')
        data2 = np.load('GRU_Truex.npy')
        dates  = np.load('datesx.npy')
        plot.plot(dates, data2)
        plot.plot(dates, data1)
        highPred = np.array(data1)
        ...
        data1 = np.load('CNN_Predx.npy')
        data2 = np.load('CNN_Truex.npy')
        dates  = np.load('datesx.npy')
        plot.plot(dates, data2)
        plot.plot(dates, data1)
        highPred = np.array(data1)
